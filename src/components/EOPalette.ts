...
export class EOPalette extends EOPopup {
    ...
    popup(
        ...
        // Favorite colors
        const textFavoriteColors =
            window.localStorage.getItem(FavoriteColorsKey);
        ...
        const colorPreview =
            this.querySelector<HTMLDivElement>('#color-preview')!;
        ...
        this.querySelectorAll<HTMLDivElement>('div.color-circle').forEach(
            (div) => {
                div.addEventListener('click', () => {
                    const color = EColor.format(
